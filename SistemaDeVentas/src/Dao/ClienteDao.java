...
public class ClienteDao {
    ...
    public boolean RegistrarCliente(ClienteTo cl){
   ...
   public List ListarCliente(){
       List<ClienteTo> ListaCl = new ArrayList();
   ...
   public boolean ModificarCliente(ClienteTo cl){
   ...
   public ClienteTo Buscarcliente(int dni){
       ClienteTo cl = new ClienteTo();
